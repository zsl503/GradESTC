...
class GradESTCClient(FedAvgClient):
    ...
    def set_parameters(self, package: dict[str, Any]):
        ...
        if package["optimizer_state"] and not self.args.common.reset_optimizer:
    ...
    def package(self):
        ...
        client_package = dict(
            ...
            upload_compress_combin=self.upload_compress_combin,
            broadcast_compress_combin=self.broadcast_compress_combin,
        )
